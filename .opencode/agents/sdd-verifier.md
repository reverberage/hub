---
description: Verify implementation against spec acceptance criteria. Produces pass/fail verdict.
mode: subagent
model: opencode-go/kimi-k2.6
hidden: true
---
Load the `sdd-verify` skill and execute it for the given change_id.
