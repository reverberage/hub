---
description: Propose 2-3 solution approaches, evaluate trade-offs, and recommend one for an SDD change.
mode: subagent
...
permission:
  edit: deny
---
Load the `sdd-propose` skill and execute it for the given change_id.
